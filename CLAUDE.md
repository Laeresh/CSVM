...
- `src/Flight/CrashChoreography.cs` — the dirt-crash effect timeline (item 8): spark bursts, a delayed fireball cluster, the black smokeball, anchored at the plane centre.
