...
**Active plan: [`docs/PLAN-m3-polish-2.md`](docs/PLAN-m3-polish-2.md)** (14 items, waves A–D, scaffolded 2026-07-30) — M3 combat look & feel from `backlog.md`. Wave position: all 14 items resolved; B12/C24/C25 sit ◐ awaiting their cockpit A/Bs. **Next:** the owed playtests (PT-05..PT-12), then plan close-out. Verify any change with **`.\RunTests.ps1`** (build → units → in-engine suites → golden hashes → one exit code); read [`docs/verification.md`](docs/verification.md) before measuring anything.
