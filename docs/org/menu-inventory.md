...
GameOptions and Video are built: the difficulty and the presentation stand on the first and the
graphics mode on the second, and `PF_B_GAMEOPTIONS` and `PF_B_VIDEO` are live.
