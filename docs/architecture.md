...
`_PhysicsProcess` (realtime clock) or by `GameSession` (fixed/halted clock). An AI aircraft
...
The 40 registered in-engine assertion suites cover plane/loadout bindings (stock and, since M3 B4,
