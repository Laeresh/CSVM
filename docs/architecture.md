...
- `src/Utils/PaneReadback.cs`, one frame of a pilot's pane read back off the frame path: an async GPU copy, the image built on a worker, handed to the Danger Zone cameras.
