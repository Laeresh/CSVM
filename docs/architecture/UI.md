...
`OptionsApplyExit` (the `PresentationId`, the graphics-mode and difficulty words, the four display settings, the four volume levels and the gameplay switches, null where never set).
