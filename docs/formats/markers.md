...
as the number rises, so the numbering runs outboard to inboard. This holds on all eleven player
airframes; the per-plane coordinates are omitted here because `--dump-markers` regenerates them.
(Every AI
...
| ID | symbol | text |
|---|---|---|
| 3060 | `IDS_AIRFRAMEGUNGROUPNAMES` | Nose Turret |
| 3061 | `IDS_INNERWINGGUNS` | Inner Wing Guns |
| 3062 | `IDS_OUTERWINGGUNS` | Outer Wing Guns |
| 3063 | `IDS_LOWERNOSEGUNS` | Lower Nose Guns |
| 3064 | `IDS_UPPERNOSEGUNS` | Upper Nose Guns |
| 3065 | `IDS_CENTERGUNS` | Center Guns |
| 3066 | `IDS_RIGHTFUSELAGEGUNS` | Right Fuselage Guns |
| 3067 | `IDS_RIGHTWINGGUNS` | Right Wing Guns |
| 3068 | `IDS_LEFTWINGGUNS` | Left Wing Guns |
| 3069 | `IDS_OUTERWINGGUNS2` | Outer Wing Guns 2 |
| 3070 | `IDS_INNERWINGGUNS2` | Inner Wing Guns 2 |
| 3071 | `IDS_NOSEGUNS` | Nose Guns |
| 3072 | `IDS_NOSEGUNS2` | Nose Guns 2 |
| 3073 | `IDS_REARTURRET` | Rear Turret |
| 3074 | `IDS_LOWINNERWINGGUNS` | Low Inner Wing Guns |
| 3075 | `IDS_LOWOUTERWINGGUNS` | Low Outer Wing Guns |
| 3076 | `IDS_UPPERINNERWINGGUNS` | Upper Inner Wing Guns |
| 3077 | `IDS_UPPEROUTERWINGGUNS` | Upper Outer Wing Guns |
| 3078 | `IDS_CENTERGUNS2` | Center Guns 2 |
