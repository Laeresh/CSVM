...
Part of the [format documentation](README.md) (see also [gamez.md](gamez.md), [clutter.md](clutter.md), [fogvol.md](fogvol.md) — the `fvol*` volumes named below are the ambient cloud field's authored extent). ooved from CLAUDE.md on 2026-07-18.
