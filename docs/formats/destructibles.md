...
- [Engine status — Wave C complete: objects damage, die, throw debris, break on contact, and reset](#engine-status-�-wave-c-complete-objects-damage-die-throw-debris-break-on-contact-and-reset)
