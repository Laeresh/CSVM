...
# rule 63: -ArgumentList quotes nothing itself and this repo path contains a space.
...
# user is not interacting with (verification rule 69). This console IS that process, so it is
