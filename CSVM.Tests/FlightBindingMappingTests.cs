...
public class FlightBindingMappingTests
{
    ...
    public static TheoryData<Key, InputAction> KeyboardSites => new()
    {
        ...
        { Key.Key5, InputAction.TargetPreviousEnemy },
        { Key.Key6, InputAction.TargetPreviousAlly },
        { Key.Key7, InputAction.TargetPreviousNonAircraft },
        { Key.Key8, InputAction.TargetNearestEnemy },
