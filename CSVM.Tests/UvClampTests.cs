...
/// the shore, so only U is safe to clamp — the both-axes test used to reject the surface
/// outright and leave the U wrap bleeding the texture's opaque edge into the water.
/// </summary>
