...
public sealed partial class LaunchMenu : CanvasLayer
{
    ...
    // rumble), the graphics mode and the rocket carve under it, the four display settings in the
    // order the Original presentation's VIDEO page draws them, the four volume levels in the order
    // its AUDIO page draws them, then the two doors.
    private const int OptionsStepperRows = 15;
    // How many Options rows show at once. Seventeen rows do not fit the band at 720p, and a band sized
