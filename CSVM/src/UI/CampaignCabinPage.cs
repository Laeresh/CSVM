...
public sealed class CampaignCabinPage : CampaignPage
{
    ...
    /// <inheritdoc/>
    /// <remarks>The pilot's own aircraft, behind the cabin's hangar window
    /// (<c>PC_P_HANGAR&lt;airframe&gt;.JPG</c>). Null today regardless of the file's presence: the
    /// engine-free decoder covers TGA only (<see cref="TgaImage"/>) and this art ships as JPG, a
    /// named gap the plan's C22 section records rather than papering over.</remarks>
    public override HangarArt? Art => PlanePhoto();
