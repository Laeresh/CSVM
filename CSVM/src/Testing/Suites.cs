...
public static class Suites
{
    ...
    private static void PufferTrailOffset(TestContext ctx, PufferState state)
    {
        ...
        // Remove only random scatter so this test observes the attachment transform itself. The
        // offset and interval above still come from the retail reader and are asserted independently.
