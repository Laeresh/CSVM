...
public sealed class PlaneStats
{
    ...
    // feed B2's per-frame slot update; Inaccuracy/DistFactor are B4/B5's and land with those items.
    // Fallbacks are the executable's own compiled defaults, not the shipped player.json values.
