...
/// never one call per player. Detail on why the shape is the point of the seam:
/// this module's docs/architecture.md entry.
/// <see cref="SpawnPicker"/> implements it directly, looping its own per-player
/// <c>ChooseSpawn</c> — the plain behaviour for solo flight, Dogfight and any scripted run.</summary>
