...
/// <c>_campaign</c> field and the sibling of <see cref="InstantAction.InstantActionDirector"/>. A plain sealed
...
public sealed class CampaignDirector
{
    ...
    internal sealed class RosterInputs
    {
        ...
        /// (<c>Session/World/SurfaceVehicleRuntime.cs</c>). Null on a stage with no chapter world, which
