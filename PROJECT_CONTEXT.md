...
**Active plan: [`docs/PLAN-puffer-interface.md`](docs/PLAN-puffer-interface.md)** — HANDOFF DRAFT,
decisions not yet settled; next session must open with `/grilling` (item A1). Owed at the
controls: `PT-27`, `PT-28`, `PT-41` and `PT-42`
