...
**Active plan:** [`docs/PLAN-menu-presentations.md`](docs/PLAN-menu-presentations.md), at Wave B.
Next: `B12` runs Built-in Free Flight through the presentation host; `B13` delivers Original Free Flight under the remake-only rule; `BL-628`, `BL-546`, `BL-535`, `BL-597` and CM13's race pace remain owed at the controls.
