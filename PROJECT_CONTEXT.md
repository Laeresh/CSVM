...
**Active plan:** [`docs/PLAN-bounce-launch.md`](docs/PLAN-bounce-launch.md) — Wave A, `A1`–`A3` landed.
**Next:** `A4` (keep the instance alive while a bounce is pending). Owed cockpit re-tests (`PT-13`–`PT-28`) remain in
