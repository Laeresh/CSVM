...
**Active plan: [`docs/PLAN-targeting.md`](docs/PLAN-targeting.md)** — player-selected targeting, on branch `worktree-targeting`. Wave A done, B11-B14 landed (targeting is live in `--fly`); A1's decode is in [`docs/org/targeting.md`](docs/org/targeting.md) and C22 is unblocked. Next: **B15**.
