...
**No active plan.** `PLAN-object-motion-decode.md` and `PLAN-surface-id-weapons.md` both completed
2026-08-13 and moved to [`docs/plans/`](docs/plans/plans.md). Next: pick the next backlog item to plan.
Owed at the controls: `PT-28`, `PT-41`, `PT-43` (4-player pane only), `PT-45`, `PT-46` and `PT-47`
