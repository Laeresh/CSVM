...
**Active plans:** [`docs/PLAN-enhanced-graphics.md`](docs/PLAN-enhanced-graphics.md), at Wave D (next `D31`, the performance gate, and `D32`, the divergence record); [`docs/PLAN-menu-presentations.md`](docs/PLAN-menu-presentations.md), at Wave A.
Next: `A1` inventories every in-scope menu journey and its original evidence; `BL-628`, `BL-546`, `BL-535`, `BL-597` and CM13's race pace remain owed at the controls.
