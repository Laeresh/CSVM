...
**Active plan:** [`docs/PLAN-public-release.md`](docs/PLAN-public-release.md), the public release, Wave D open, its `D32` next; A1's Known Issues draft is that file's appendix.
