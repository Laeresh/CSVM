...
2026-08-13). A1 landed (front-loaded); next: A2 (the AI actor seam) and A4 (the multi-zone
decision), with C9a startable in parallel. Owed at the controls: `PT-28`, `PT-41`, `PT-43`
