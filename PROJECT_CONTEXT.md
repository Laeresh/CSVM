...
**Active plan: [`docs/PLAN-targeting.md`](docs/PLAN-targeting.md)** — player-selected targeting, on branch `worktree-targeting`. Wave A in progress; A1's decode is in [`docs/org/targeting.md`](docs/org/targeting.md) and B13/C22 are unblocked; A2 landed. Next: **A3** (one-file fix), then **B11**.
