...
**Active plan:** [`docs/PLAN-flight-model-parity.md`](docs/PLAN-flight-model-parity.md), Wave C.
Next: C22, then C23. The cockpit sitting `BL-436` is the freshest owed playtest.
