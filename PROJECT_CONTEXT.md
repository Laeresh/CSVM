...
**Active plan:** [`docs/PLAN-M5-polish-2.md`](docs/PLAN-M5-polish-2.md), Waves A to C landed and flown, Wave D landed.
Next: `D21` (the Wave D sortie, at the controls). `PT-84` and the `BL-120`/`PT-53` corner graze are the freshest owed playtests.
