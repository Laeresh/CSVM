...
**Active plans:** [`docs/PLAN-enhanced-graphics.md`](docs/PLAN-enhanced-graphics.md), at Wave B (next `B11`, the lit world shader variant); [`docs/PLAN-menu-presentations.md`](docs/PLAN-menu-presentations.md), at Wave A.
