...
**Active plan: [`docs/PLAN-c3-balloon-kill-chain.md`](docs/PLAN-c3-balloon-kill-chain.md)** (`BL-348`, C3/M02's balloon kill chain). Wave A and Wave B are done (B2–B5 all disproven). Next: **C6**, retire `BL-348`. Completed plans are in [`docs/plans/`](docs/plans/plans.md).
