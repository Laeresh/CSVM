...
(items 1–6), `C7` landed; Wave C (`C8`–`C10`) remains, sequential, one golden-moving item per
landing window. **Next:** `C8` (`BL-257`), then `C9`/`C10`; also owed: the `PT-39` gun-line/splash cockpit
