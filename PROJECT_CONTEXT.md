...
**Active plan: [`docs/PLAN-flight-drag-lift.md`](docs/PLAN-flight-drag-lift.md)** (written
2026-08-07) — `BL-092` + `BL-247`, at Wave B. Next: `B11`, `B12`, `B13`.
