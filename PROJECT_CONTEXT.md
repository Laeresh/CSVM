...
**Active plan:** [`docs/PLAN-flight-model-parity.md`](docs/PLAN-flight-model-parity.md), Wave E.
Next: E41 and E42, with C23 owed at the controls. The cockpit sitting `BL-436` is the freshest owed playtest.
