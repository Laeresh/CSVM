...
**Active plan:** [`docs/PLAN-deepening.md`](docs/PLAN-deepening.md) — Wave A landed `A1`.
**Next:** `A2` (settle the integration step, unit-test `Ballistics`); `D8`/`E12` are ungated grilling
