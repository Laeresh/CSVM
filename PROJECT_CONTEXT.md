...
**Active plans:** [`docs/PLAN-menu-presentations.md`](docs/PLAN-menu-presentations.md) at Wave A, [`docs/PLAN-M5-polish-8.md`](docs/PLAN-M5-polish-8.md) at Wave D, and [`docs/PLAN-M5-polish-9.md`](docs/PLAN-M5-polish-9.md) at Wave D.
Next: menu `A1` inventories every in-scope menu journey and its original evidence; polish-8 `D31` and polish-9 `D31` fly in one sitting, consuming `PT-97` to `PT-117`; `BL-535` and CM13's race pace remain owed at the controls, as does the enhanced mode's pass against `docs/plans/PLAN-enhanced-graphics.md`'s Open judgements.
