...
**Active plan:** [`docs/PLAN-bounce-launch.md`](docs/PLAN-bounce-launch.md) — Wave A, `A1`–`A4` landed.
**Next:** `A5` (engine suite on motion + dispatch). Owed cockpit re-tests (`PT-13`–`PT-28`) remain in
