...
**Active plans:** [`docs/PLAN-public-release.md`](docs/PLAN-public-release.md) at `E42`, A1's Known Issues draft being that file's appendix; [`docs/PLAN-enhanced-graphics-2.md`](docs/PLAN-enhanced-graphics-2.md) at Wave A, orchestrated on branch `enhanced-graphics-2`.
