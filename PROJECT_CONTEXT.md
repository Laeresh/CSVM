...
**Active plan:** [`docs/PLAN-animruntime-dispatch.md`](docs/PLAN-animruntime-dispatch.md) — Waves
A, B and C (sound, light, pose/visual families) landed; next D31, D32 (surface trim).
