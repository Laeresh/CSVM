...
**No plan active** — `PLAN-m3-polish-7` completed 2026-08-05, indexed in
[`docs/plans/plans.md`](docs/plans/plans.md). **Next:** the owed cockpit re-tests (`PT-13`–`PT-37`,
[`playtest.md`](playtest.md)) and their `CAP-nn` captures, or scope the next plan from `backlog.md`
with **`/new-plan`**. Verify any change with
