...
**Active: [`docs/PLAN-instant-action.md`](docs/PLAN-instant-action.md)**, Wave A decoded, `F12` done, `G13` next;
[`docs/PLAN-perf-hitches.md`](docs/PLAN-perf-hitches.md) also open, Wave A. M4 (Game AI) completed
