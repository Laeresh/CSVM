...
**Active plan:** [`docs/PLAN-menu-presentations.md`](docs/PLAN-menu-presentations.md), at Wave C.
Next: `C23` separates the hangar feature and delivers its Original screens, then Wave D's `D31`; the Original pointer, cues, the pad join and the return from a flown Free Flight are owed at the controls; `BL-628`, `BL-546`, `BL-535`, `BL-597` and CM13's race pace remain owed at the controls.
