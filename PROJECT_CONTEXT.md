...
disproves `PLAN-crash-surface-id` Decision 3. Strictly serial. Next: the `A2` decision, which gates
the rest. [`PLAN-object-motion-decode.md`](docs/PLAN-object-motion-decode.md) is live in
