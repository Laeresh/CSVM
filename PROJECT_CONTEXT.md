...
**Active plan:** [`docs/PLAN-M5-polish-2.md`](docs/PLAN-M5-polish-2.md), Wave A in progress.
Next: `A2` .. `A6`. `PT-84` and the `BL-120`/`PT-53` corner graze are the freshest owed playtests.
