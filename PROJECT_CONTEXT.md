...
**Active plan:** [`docs/PLAN-M5-polish-5.md`](docs/PLAN-M5-polish-5.md), every item landed and verified on the plan branch.
Next: `D31`, the CM04 to CM09 (plus CM13) sortie at the controls, then close the plan.
