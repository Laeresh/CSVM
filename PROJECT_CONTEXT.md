...
**Active plan:** none; the last completed is [`docs/plans/PLAN-M5-polish-2.md`](docs/plans/PLAN-M5-polish-2.md).
Next: `PT-84` and the `BL-120`/`PT-53` corner graze are the freshest owed playtests.
