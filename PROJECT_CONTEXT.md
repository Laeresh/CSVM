...
**Active plan:** [`docs/PLAN-bounce-launch.md`](docs/PLAN-bounce-launch.md) — Wave A, `A1`–`A5` landed.
**Next:** `A6` (record the landing-height ⚠ choice in `docs/formats/destructibles.md`, then close `BL-240`). Owed cockpit re-tests (`PT-13`–`PT-28`) remain in
