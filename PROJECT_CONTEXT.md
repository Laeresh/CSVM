...
**Active plans:** [`docs/PLAN-M5-polish-12.md`](docs/PLAN-M5-polish-12.md), the menu seam, `E41`'s sortie owed; [`docs/PLAN-M5-polish-13.md`](docs/PLAN-M5-polish-13.md), its leftovers, `A1` next.
