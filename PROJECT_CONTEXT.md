...
**Active plans:** [`docs/PLAN-enhanced-graphics.md`](docs/PLAN-enhanced-graphics.md), at Wave C (next `C21`, the emissive exempt surfaces, and `C23`, SSAO); [`docs/PLAN-menu-presentations.md`](docs/PLAN-menu-presentations.md), at Wave A.
