...
deletes `DebrisTune`. Wave A in progress (A1, A2 done); Waves B and C must run strictly serially.
Next: `A3` (flag `0x2000` = `COMPLEX`: the suppressed gravity add), then Wave B.
