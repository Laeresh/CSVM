...
**Active plans:** [`docs/PLAN-menu-presentations.md`](docs/PLAN-menu-presentations.md), every item landed and `E44` open on the at-the-controls rows, and [`docs/PLAN-M5-polish-8.md`](docs/PLAN-M5-polish-8.md) at Wave D.
