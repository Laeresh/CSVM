...
Next: `C21` extracts the Instant Action feature and `C22` the shared player setup, then `C23` the hangar; the Original pointer, cues and the return from a flown Free Flight are owed at the controls; `BL-628`, `BL-546`, `BL-535`, `BL-597` and CM13's race pace remain owed at the controls.
