...
**Active plan: [`docs/PLAN-template-stage.md`](docs/PLAN-template-stage.md)** — Wave A complete
(A1–A4 ☑); next item **B11** (`EnsureWorldEffects`' signature fold — go/no-go decides it).
