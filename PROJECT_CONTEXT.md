...
**Active plan:** [`docs/PLAN-public-release.md`](docs/PLAN-public-release.md), the public release, Wave E open, its `E41` next; A1's Known Issues draft is that file's appendix. Also live: [`docs/PLAN-cinemas.md`](docs/PLAN-cinemas.md), the MPG movies, Wave C open, its `C21` next.
