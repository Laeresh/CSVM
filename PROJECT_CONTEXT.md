...
Next: `D32` migrates the campaign boards' fixed chrome onto decoded layouts, then `D33` completes Original's campaign; the Original pointer, cues, the pad join and the return from a flown Free Flight are owed at the controls; `BL-628`, `BL-546`, `BL-535`, `BL-597` and CM13's race pace remain owed at the controls.
