...
**No active plan.** The last one,
[`docs/plans/PLAN-anim-original-match.md`](docs/plans/PLAN-anim-original-match.md), landed the
animation interpreter matched against the decompiled original (evidence:
[`analysis/anim-interpreter-decode/`](analysis/anim-interpreter-decode/FINDINGS.md)).
