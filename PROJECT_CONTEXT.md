...
**Active plan: [`docs/PLAN-flight-model-rewrite.md`](docs/PLAN-flight-model-rewrite.md)** — Wave A open, `A2` next; runs in the `flight-model-decode` worktree, on [`docs/org/flightModel.md`](docs/org/flightModel.md)'s `crimson.exe` decode.
