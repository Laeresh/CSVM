...
**Active plan:** [`docs/PLAN-public-release.md`](docs/PLAN-public-release.md), the public release, Wave E open, its `E43` next; A1's Known Issues draft is that file's appendix.
