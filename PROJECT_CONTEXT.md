...
**Active plan:** [`docs/PLAN-public-release.md`](docs/PLAN-public-release.md), the public release, Wave D open, its `D34` next; A1's Known Issues draft is that file's appendix. Also live: [`docs/PLAN-video-preferences.md`](docs/PLAN-video-preferences.md), `BL-768`'s VIDEO page, Wave A open, its `A1` next.
