...
Next: `BL-628` (the docking hook's repeated animation), `BL-546`, `BL-535`, `BL-597` and CM13's race pace are owed at the controls; `BL-658` (the ammo screen's second description pane) and `BL-659` (no aid opens a combo box) are open.
