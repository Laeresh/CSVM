...
**No plan active** — `PLAN-friends-release` and `PLAN-m3-polish-8` both completed 2026-08-05,
indexed in [`docs/plans/plans.md`](docs/plans/plans.md). **Next:** the `PT-39` gun-line/splash
cockpit flight, the owed cockpit re-tests (`PT-26`–`PT-28`, `PT-31`–`PT-37`,
