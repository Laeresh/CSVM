...
with them) and `D10` with them; `D11`–`D13` are next. One look question stays open with no item:
debris resting too deep, whose chain is decoded and carries no extent term.
