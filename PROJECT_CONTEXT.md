...
**Active plan:** [`docs/PLAN-cockpit-view.md`](docs/PLAN-cockpit-view.md) (BL-080, the two
first-person views) — Wave A open, next item A1. Completed plans are indexed in
[`docs/plans/plans.md`](docs/plans/plans.md).
