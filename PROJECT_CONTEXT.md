...
**Active plan:** [`docs/PLAN-deepening.md`](docs/PLAN-deepening.md) — Waves A, B, C, D and E complete (`BL-241` closed); Wave F's `F16` done.
**Next:** `F17`, then Wave G (`G18`, now unblocked).
