...
**Active plan:** [`docs/PLAN-deepening.md`](docs/PLAN-deepening.md) — Waves A, B, C and D complete; E through `E13`.
**Next:** `E14` (the counting fake against `E13`'s seam, installed via
`WorldSession.Options.EmitterFactory`), then `E15`/`E15b`.
