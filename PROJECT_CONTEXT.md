...
2026-08-13). A1 and A2 landed; next: A4 (the multi-zone decision) and wave B (B5 net
following), with C9a startable in parallel. Owed at the controls: `PT-28`, `PT-41`, `PT-43`
