...
**Active plan: [`docs/PLAN-engine-free-suites.md`](docs/PLAN-engine-free-suites.md)** — Wave A
done (A1/A3/A2/A4 ☑, `tex-dropin` ❌); next Wave B `B11`. Owed at the
