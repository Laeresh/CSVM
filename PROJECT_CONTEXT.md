...
**Active plan:** [`docs/PLAN-M5-polish-5.md`](docs/PLAN-M5-polish-5.md), Waves A to C mostly landed; `A4`, `B14`, `C22`, `E41` in flight.
Next: `C21` (`BL-576`) after `A4`, then the full battery with the golden re-pin, then `D31`.
`PT-84` and `BL-120`/`PT-53` remain owed playtests.
