...
**Active plan: [`docs/PLAN-puffer-interface.md`](docs/PLAN-puffer-interface.md)** — Wave A,
A1–A2 ☑; next item **A3** (the four callers migrate, verbs go private). Owed at the
