...
**Active plan:** [`docs/PLAN-M5-polish-2.md`](docs/PLAN-M5-polish-2.md), Waves A to C landed and flown, Wave D not started.
Next: `D14` (the realtime cutscene hold) first and alone, then `D15` to `D21`. `PT-84` and the `BL-120`/`PT-53` corner graze are the freshest owed playtests.
