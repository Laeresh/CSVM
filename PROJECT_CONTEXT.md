...
Position: A1, B4, B5 landed 2026-08-05; A2→A3 and C8→C10 in flight.
**Next:** C7 (`BL-267`), C6 (`BL-265`), then Wave D. Also owed: the cockpit re-tests (`PT-26`–`PT-28`, `PT-31`–`PT-37`,
