...
Next: `A2` decodes menu layouts during ROF extraction; `B13`'s tracer needs a decision (the original's top level has no Free Flight row, see `docs/org/menu-inventory.md`); `BL-628`, `BL-546`, `BL-535`, `BL-597` and CM13's race pace remain owed at the controls.
