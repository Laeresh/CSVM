...
**Active: [`docs/PLAN-instant-action.md`](docs/PLAN-instant-action.md)**, Wave A decoded, `B7` done, `C8` next;
...
`PT-41`, `PT-43` (4-player pane only), `PT-45`, `PT-46` and `PT-47` ([`playtest.md`](playtest.md)).
