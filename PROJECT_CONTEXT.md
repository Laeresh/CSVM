...
[`analysis/anim-interpreter-decode/`](analysis/anim-interpreter-decode/FINDINGS.md)). Waves A–C
landed; next `D31` (the HE/flash/sonic timeline suite) and `D32`, which owns the
