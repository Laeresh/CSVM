...
**Active plan:** [`docs/PLAN-M5-polish-2.md`](docs/PLAN-M5-polish-2.md), Wave A not started.
Next: `A1` (retire the record's stale pointers, including both older M5 plan banners), then `A2`. `PT-84` and the `BL-120`/`PT-53` corner graze are the freshest owed playtests.
