...
**Active plan:** [`docs/PLAN-flight-model-parity.md`](docs/PLAN-flight-model-parity.md), Wave A.
Next: A2, then A3. The cockpit sitting `BL-436` is the freshest owed playtest.
