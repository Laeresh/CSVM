...
**Active plan:** [`docs/PLAN-M5-polish-2.md`](docs/PLAN-M5-polish-2.md), Waves A to C landed and flown, Wave D in progress.
Next: `D14`, `D19`, `D20` in flight; then `D15` and `D18`, `D16`, `D17`, and `D21` (the stop). `PT-84` and the `BL-120`/`PT-53` corner graze are the freshest owed playtests.
