...
**Active plan: [`docs/PLAN-ordnance-types.md`](docs/PLAN-ordnance-types.md)** (`BL-406`), 22 items in six waves, 21 landed and `F22` at the controls. Its decode is [`docs/org/ordnanceTypes.md`](docs/org/ordnanceTypes.md). **Also at the controls:** [`docs/PLAN-ai-damage-and-engine-audio.md`](docs/PLAN-ai-damage-and-engine-audio.md), every item landed, its owed playtest the last gate before its completion move and closing `BL-385`.

**Next:** `F22` (`PT-62`–`PT-76`), then the plan's completion move.
