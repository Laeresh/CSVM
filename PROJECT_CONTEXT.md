...
(items 1–6), `C7`–`C9` landed; Wave C's `C10` remains, the last golden-moving item.
**Next:** `C10` (`BL-273`); also owed: the `PT-39` gun-line/splash cockpit
flight, the `PT-41` sky-zone flight, and the cockpit re-tests (`PT-26`–`PT-28`,
