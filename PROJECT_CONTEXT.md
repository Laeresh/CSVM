...
**Active plan:** [`docs/PLAN-M5-polish-2.md`](docs/PLAN-M5-polish-2.md), Waves A to C landed, A13 in progress.
Next: `A13`, then `C12` (the sortie). `PT-84` and the `BL-120`/`PT-53` corner graze are the freshest owed playtests.
