...
**Active plans: [`docs/PLAN-overcast-match.md`](docs/PLAN-overcast-match.md)** — Wave A open, `A1` next;
**[`docs/PLAN-flight-model-rewrite.md`](docs/PLAN-flight-model-rewrite.md)** (`A1` next) — runs **only in the
`flight-model-decode` worktree**, on [`docs/org/flightModel.md`](docs/org/flightModel.md)'s `crimson.exe` decode.
