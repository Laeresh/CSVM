...
2026-08-13). All waves A–G are complete (B7 closed disproven); the checklist is done and the
plan awaits its move to `docs/plans/`. Owed at the controls: `PT-28`, `PT-41`, `PT-43`
