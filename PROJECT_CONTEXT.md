...
**No active plan.** `docs/PLAN-c3-balloon-kill-chain.md` completed and moved to
[`docs/plans/`](docs/plans/plans.md). Next: pick the next item from `backlog.md` or start a new plan
with `/new-plan`.
