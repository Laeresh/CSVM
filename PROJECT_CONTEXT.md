...
**Active plan:** [`docs/PLAN-flight-model-parity.md`](docs/PLAN-flight-model-parity.md), Wave B.
Next: B12, then B13. The cockpit sitting `BL-436` is the freshest owed playtest.
