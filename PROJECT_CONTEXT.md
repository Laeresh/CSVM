...
**Active plan:** [`docs/PLAN-deepening.md`](docs/PLAN-deepening.md) — Waves A, B, C and D complete.
**Next:** `E13` (`IEmitter`/`IEmitterFactory` + extract `EmitterDirector`, against the interface
`E12` settled).
