...
Position: Waves A–C landed 2026-08-05 (A3 resolved at the controls: triad kept, muzzle-anchored;
the C6 width pick rides `PT-39`). **Next:** Wave D — D11 (`BL-259`) → D12 (`BL-270`), then close
the plan. Also owed: the cockpit re-tests (`PT-26`–`PT-28`, `PT-31`–`PT-37`,
