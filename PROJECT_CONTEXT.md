...
backlog items, Waves A–D. **Next:** D10 (`BL-239`), with D9 (`BL-228`) last per the plan's dependency notes. Owed cockpit re-tests
(`PT-13`–`PT-35`) remain in [`playtest.md`](playtest.md). Verify any change with
