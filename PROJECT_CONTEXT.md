...
**No plan active** — `PLAN-m3-polish-8` completed 2026-08-05, indexed in
[`docs/plans/plans.md`](docs/plans/plans.md) (`PLAN-friends-release.md` runs in a concurrent
session). **Next:** the `PT-39` gun-line/splash cockpit flight, the owed cockpit re-tests
(`PT-26`–`PT-28`, `PT-31`–`PT-37`, [`playtest.md`](playtest.md)), `BL-262`, or scope the next
plan from `backlog.md` with **`/new-plan`**. Verify any change with
