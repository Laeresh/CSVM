...
- `src/Bindings/` (9) — the input binding model and the named-action seam: device identity, the tagged control, the binding list an action resolves through, and a player's action map resolved once per tick.
