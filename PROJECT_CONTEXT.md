...
**No active plan.** M4 (Game AI) completed 2026-08-14 —
[`docs/plans/PLAN-M4-ai.md`](docs/plans/PLAN-M4-ai.md), all 22 items, waves A–H. Owed at the
controls: `PT-28`, `PT-41`, `PT-43` (4-player pane only), `PT-45`, `PT-46` and `PT-47`
