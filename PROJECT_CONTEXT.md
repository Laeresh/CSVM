...
**Active plan: [`docs/PLAN-m3-polish-10.md`](docs/PLAN-m3-polish-10.md)** — all ten items landed
(six fixed, four closed). Owed at the controls: `PT-27`, `PT-28`, `PT-41` and `PT-42`
