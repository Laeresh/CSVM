...
**Active plan:** [`docs/PLAN-bounce-launch.md`](docs/PLAN-bounce-launch.md) — Wave A, `A1`–`A2` landed.
**Next:** `A3` (dispatch the bounce sequence). Owed cockpit re-tests (`PT-13`–`PT-28`) remain in
