...
**Active plan: [`docs/PLAN-m3-polish-7.md`](docs/PLAN-m3-polish-7.md)** (2026-08-04) — ten
backlog items, Waves A–D, **all ten landed**. **Next:** close the plan out — move it to
`docs/plans/` with a `COMPLETE` banner and add its row to [`plans.md`](docs/plans.md). Owed cockpit
re-tests (`PT-13`–`PT-37`) remain in [`playtest.md`](playtest.md). Verify any change with
