...
**Active plan: [`docs/PLAN-c3-balloon-kill-chain.md`](docs/PLAN-c3-balloon-kill-chain.md)** (`BL-348`, C3/M02's balloon kill chain). Next: **A1**, re-fly C3/M02 and record which of the four symptoms survive; Wave B (B2–B5) waits on it. Completed plans are in [`docs/plans/`](docs/plans/plans.md).
