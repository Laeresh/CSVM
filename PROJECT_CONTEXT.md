...
**Active plan: [`docs/PLAN-targeting.md`](docs/PLAN-targeting.md)** — player-selected targeting, on branch `worktree-targeting`. Wave A not started. Next: **A1** (decode the original's player targeting into `docs/org/targeting.md`; gates B13 and C22), or **A2**/**A3** (independent one-file fixes, unblocked).
