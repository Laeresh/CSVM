...
**Active plan: [`docs/PLAN-ordnance-types.md`](docs/PLAN-ordnance-types.md)** (`BL-406`), 22 items in six waves, 21 landed and `F22` at the controls. Its decode is [`docs/org/ordnanceTypes.md`](docs/org/ordnanceTypes.md).
