...
**Active plan:** [`docs/PLAN-deepening.md`](docs/PLAN-deepening.md) — Waves A, B and C complete.
**Next:** `D9` (extract `MotionSet`) and `E13` (`IEmitter`/`IEmitterFactory` + extract
`EmitterDirector`) — both start against interfaces the `D8`/`E12` grillings settled.
