...
**No active plan.** `PLAN-object-motion-decode.md` completed all 13 items 2026-08-13 and moved to
[`docs/plans/`](docs/plans/plans.md). Next: pick the next backlog item to plan.
