...
**No active plan** — [`docs/PLAN-engine-free-suites.md`](docs/plans/PLAN-engine-free-suites.md)
completed 2026-08-06 (all items ☑, `tex-dropin` ❌); run **`/new-plan`** to start the next one.
