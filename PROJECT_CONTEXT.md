...
**Active plan:** [`docs/PLAN-M5-polish-2.md`](docs/PLAN-M5-polish-2.md), Waves A to D landed and flown.
Next: the sortie's follow-ups `BL-551` to `BL-554` in the backlog, or the plan's close-out. `PT-84` and the `BL-120`/`PT-53` corner graze are the freshest owed playtests.
