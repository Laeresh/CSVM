...
**Active plan:** none. Completed plans are indexed in
[`docs/plans/plans.md`](docs/plans/plans.md); next work comes from [`backlog.md`](backlog.md) —
the cockpit sitting `BL-436` is the freshest owed playtest.
