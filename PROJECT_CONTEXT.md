...
**Active plan:** [`docs/PLAN-M5-polish-2.md`](docs/PLAN-M5-polish-2.md), Waves A to D landed and flown, Wave E landed.
Next: `E27`, the Wave E sortie (the stop). `PT-84` and the `BL-120`/`PT-53` corner graze are the freshest owed playtests.
