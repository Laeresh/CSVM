...
**Active plan:** [`docs/PLAN-M5-polish-14.md`](docs/PLAN-M5-polish-14.md), ten player-visible defects in five waves, all nine code items landed, `E41`'s sortie next; [`docs/PLAN-public-release.md`](docs/PLAN-public-release.md) waits behind it at `E41`, and A1's Known Issues draft is that file's appendix.
